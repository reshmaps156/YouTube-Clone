        ...
        <div className="col-md-10">
          ...
          <div className='row mt-5'>
            ...
            <div className="col-md-7 ">
              ...
              <div className="row">
                <div className="col-md-4">
                 ...
                 <div className='d-flex mt-1 fw-bold'> <p className='shortsDescription'>Lorem ipsum | dolor sit|  amet consectetur .....</p>
                 <MoreVertIcon/>
                 </div>
                </div>
                <div className="col-md-4">
              ...
              <div className="row mt-2 videoHistory">
                <div className="col-md-4">
                ...
                <div className="col-md-1">
                  <div className='d-flex clearHistoryBtn'>
                    <CloseOutlinedIcon />
                    <MoreVertIcon />
                  </div>
                </div>
            ...
            <div className="col-md-4 mt-3 p-5 ">
              ...
              <p className='border-0 mt-3 bg-transparent historySetFont'><FontAwesomeIcon icon={faTrashCan} className='ms-1 me-3' />Clear all watch history</p>
              <p className='border-0 mt-3 bg-transparent historySetFont'><PauseOutlinedIcon className='ms-1 me-3' />Pause watch history</p>
              <p className='border-0 mt-3 bg-transparent historySetFont'><SettingsOutlinedIcon className='ms-1 me-3' />Manage all history</p>
              <p className='text-secondary mt-3 ms-5 historySetFont'>Comments</p>
              <p className='text-secondary ms-5 historySetFont'>Posts</p>
              <p className='text-secondary ms-5 historySetFont'>Live Chats</p>
            </div>
          </div>
