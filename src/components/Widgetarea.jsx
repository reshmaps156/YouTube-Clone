        ...
        <>
            <Sidebar className='sideBar'>
                <Menu>
                    ...
                    <Link to={'/'} className='unStyle'><MenuItem className=''><HomeSharpIcon className='me-2' /><span className='sideBarDetail'> Home</span> </MenuItem></Link>
                    ...
                    <Link to={'/history'} className='unStyle'><MenuItem><RestoreOutlinedIcon className='me-3' /><span className='sideBarDetail'> History </span></MenuItem></Link>
                    ...
                    <Link className='unStyle' to={'/watchlater'}><MenuItem> <ScheduleOutlinedIcon className='me-3' /><span className='sideBarDetail'>Watch later</span> </MenuItem></Link>
